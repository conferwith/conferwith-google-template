...

{
  ...
  "description": "The Conferwith Tracking is used to track online shopper activities in the ecommerce sites which use conferwith app",
  "containerContexts": [
    "WEB"
  ]
}
...
injectScript('https://expert.conferwith.io/public/scripts/postReq.js', onSuccess, onFailure);
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://expert.conferwith.io/public/scripts/postReq.js"
              }
            ]
          }
        }
